...
export interface SpillState {
  ...
  dayStats: { soldKr: number; bakgrunnKr: number; bakgrunnKunder: number; bakgrunnStk: number; tapteSalgStk: number; tapteSalgKr: number; manglerPrisStk: number; overprisStk: number }
