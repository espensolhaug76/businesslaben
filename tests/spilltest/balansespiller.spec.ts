...
const STRATEGIER: Strategi[] = [
  ...
  },
  {
    ...
    // høyt markedsbudsjett (30 000 kr/mnd fordelt på 3 kanaler mot målgruppa),
    // bemanning mot kø (spiller + 1 Junior ⇒ 240 kunder/dag kapasitet). Priser =
    // veiledende. NB: markedsføringseffekten følger NÅ lopendeMarkedsforingsfaktor
    // (per kanal × treff), ikke den gamle flate skala-faktoren.
    opening: [
  ...
  },
  {
    ...
    // Som 2, pluss løpende markedsføring (10 000 kr/mnd fordelt på 3 kanaler mot
    // målgruppa). NY MODELL: effekten avhenger av kanal-treff i segmentene
    // (lopendeMarkedsforingsfaktor), ikke bare kronene.
    opening: [
      { productId: 'coffee', qty: 150 }, { productId: 'croissant', qty: 45 },
      { productId: 'kanelbolle', qty: 45 }, { productId: 'skolebrod', qty: 45 },
      { productId: 'muffin-blabaer', qty: 45 },
