...
function PriserTab({ utkast, setUtkast, lagretMin, setLagretMin }: {
  ...
  const { state, dispatch } = useGame()
  // DEFAULT-PRIS = INNKJØPSPRIS (DEL 6, 10.08): varer prises til innkjøpspris allerede
  // ved anskaffelse (catalogToProduct), så Priser-fanen viser bare GJELDENDE priser —
  // ingen forhåndsutfyllingslogikk her lenger. Fella (null margin) ligger i default-en;
