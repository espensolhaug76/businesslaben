...
const TERMS: Record<string, string> = {
  'Den norske modellen': 'Det norske systemet for samarbeid mellom stat, arbeidsgivere og arbeidstakere som har gitt høy velferd og lav ulikhet.',
  'Hovedavtalen': 'Grunnleggende avtale mellom NHO og LO fra 1935, kjent som "arbeidslivets grunnlov".',
  'Trepartssamarbeidet': 'Samarbeid mellom de tre partene: staten, arbeidsgiverne (NHO) og arbeidstakerne (LO).',
  'NHO': 'Næringslivets Hovedorganisasjon – arbeidsgiverorganisasjon som representerer norske bedrifter.',
  'LO': 'Landsorganisasjonen i Norge – Norges største fagforeningsorganisasjon for arbeidstakere.',
  'Frontfagsmodellen': 'System der konkurranseutsatt industri forhandler lønn først, og resten av arbeidslivet følger etter.',
  'Tariffavtale': 'Kollektiv avtale mellom fagforeninger og arbeidsgiverorganisasjoner om lønn og arbeidsvilkår.',
  'Medvirkning': 'Arbeidstakers rett og plikt til å delta i avgjørelser som angår arbeidssituasjonen.',
}
const QUIZ_SLIDES: QuizQuestion[] = [
  {
    question: 'Hvem representerer primært arbeidstakerne i norsk arbeidsliv?',
    options: [
      'NHO (Næringslivets Hovedorganisasjon)',
      'LO og andre fagforeninger og forbund',
  ...
  },
  {
    ...
    options: [
      'En avtale om tekniske standarder og tolltariffer',
      'En kollektiv avtale om lønn og arbeidsvilkår mellom arbeidsgiver og fagforening',
      'En handelsavtale mellom norske og utenlandske bedrifter',
      'En leieavtale for næringslokaler',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    ...
    options: [
      'En bonusordning for ekstra innsats på jobben',
      'En kollektiv arbeidsnedleggelse for å fremme lønns- og arbeidskrav',
      'En frivillig permisjonsordning for ansatte',
      'En oppsigelsesprosedyre i virksomheten',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    ...
    options: [
      'En modell for å rekruttere ansatte fra fronten i forsvaret',
      'Et system der konkurranseutsatt industri forhandler lønn først, og resten følger etter',
      'En metode for å sette frem krav i lønnsforhandlinger',
      'En fagforening for frontlinjepersonell i servicenæringen',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    ...
    options: [
      'Et samarbeid mellom tre konkurrerende fagforeninger',
      'Samarbeid mellom staten, arbeidsgiverne (NHO) og arbeidstakerne (LO)',
      'Et samarbeid mellom tre nordiske land om arbeidsmarkedspolitikk',
      'Et trinnvis lønnssystem med tre nivåer',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: 'clamp(3rem, 10vw, 8rem)', fontWeight: 800, marginBottom: 32, letterSpacing: '-0.03em', lineHeight: 1.05 }}>
        Partene i<br /><span style={{ color: '#38bdf8', fontStyle: 'italic' }}>arbeidslivet</span>
      </h1>
      <p style={{ fontSize: 22, color: '#94a3b8', marginBottom: 48, maxWidth: 600, margin: '0 auto 48px', fontWeight: 300, lineHeight: 1.6 }}>Modul 18 – Den norske modellen og trepartssamarbeidet.</p>
...
function Slide1({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul 18 – Slide 1</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}>Hva er <Term word="Den norske modellen" onShow={show} />?</h2>
          <p style={bodyText}>Det er måten vi har organisert samfunnet vårt på. Den bygger på et tett samarbeid mellom staten, arbeidsgiverne (eks: <Term word="NHO" onShow={show} />) og arbeidstakerne (eks: <Term word="LO" onShow={show} />).</p>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80" alt="Den norske modellen" />
      </div>
    </Glass>
  )
}
...
function Slide2({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=800&q=80" alt="Historien bak" />
        <div>
          <SlideLabel>Modul 18 – Slide 2</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}>Historien bak (1935)</h2>
          <p style={bodyText}>Før i tiden var det mye krangling og streik i Norge. I 1935 ble man enige om <Term word="Hovedavtalen" onShow={show} />, som kalles "arbeidslivets grunnlov". Den skapte fred og regler for hvordan vi skal samarbeide.</p>
        </div>
      </div>
    </Glass>
  )
  ...
  return (
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 900, margin: '0 auto' }}>
        <SlideLabel>Modul 18 – Slide 3</SlideLabel>
        <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 32, lineHeight: 1.1 }}><Term word="Trepartssamarbeidet" onShow={show} /></h2>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1.5rem' }}>
          {[
            { icon: '🏛️', title: 'Staten', desc: 'Lager lover og sikrer velferden.' },
            { icon: '🏢', title: 'NHO', desc: 'Representerer arbeidsgiverne og bedriftene.' },
            { icon: '👷', title: 'LO', desc: 'Representerer arbeidstakerne og fagforeningene.' },
          ].map(p => (
        ...
        <p style={{ ...bodyText, marginTop: 32, fontSize: 16 }}>De tre partene møtes for å bli enige om lønn, pensjon og lover. Dette sikrer stabilitet og trygghet for alle.</p>
      </div>
    </Glass>
  )
}
...
function Slide4({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul 18 – Slide 4</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}><Term word="Frontfagsmodellen" onShow={show} /></h2>
          <p style={bodyText}>Industrien forhandler om lønn først. Dette sikrer at lønningene i Norge ikke blir så høye at vi ikke får solgt varene våre til utlandet.</p>
          <div style={{ marginTop: 24, padding: '1.5rem', background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16 }}>
            <p style={{ color: '#38bdf8', fontWeight: 600, fontSize: 16, margin: 0 }}>Industri forhandler først → Resten følger etter</p>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=800&q=80" alt="Frontfagsmodellen" />
      </div>
    </Glass>
  )
}
...
function Slide5({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80" alt="Tillit og medvirkning" />
        <div>
          <SlideLabel>Modul 18 – Slide 5</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}>Tillit og <Term word="Medvirkning" onShow={show} /></h2>
          <p style={bodyText}>I Norge stoler vi på hverandre. Du som ansatt har rett til å medvirke, som betyr at sjefen må lytte til dine meninger om din egen arbeidsdag.</p>
        </div>
      </div>
    </Glass>
  )
...
function Slide6({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul 18 – Slide 6</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}><Term word="Tariffavtale" onShow={show} /></h2>
          <p style={bodyText}>Det er felles regler for lønn, arbeidstid og ferie for en hel bransje. Det sikrer at alle får en rettferdig behandling, uansett hvilken bedrift de jobber i.</p>
          <ul style={{ ...listStyle, marginTop: 20 }}>
            {['Lik lønn for likt arbeid', 'Faste arbeidstider', 'Rettferdig feriegodtgjørelse'].map(item => (
        ...
        <SlideImg src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80" alt="Tariffavtale" />
      </div>
    </Glass>
  )
}
  ...
  return (
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        <SlideLabel>Modul 18 – Slide 7 – Utfordringer</SlideLabel>
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 4rem)', fontWeight: 800, marginBottom: 32, lineHeight: 1.2 }}>Utfordringer</h2>
        <div style={{ background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.25)', borderRadius: 24, padding: '2.5rem', marginBottom: 24 }}>
          <p style={{ ...bodyText, fontSize: 18, color: '#fca5a5', margin: 0 }}>Færre unge organiserer seg i fagforeninger i dag. Hvis modellen forsvinner, mister vi de gode rettighetene våre.</p>
        </div>
        <p style={{ color: '#64748b', fontSize: 15, fontStyle: 'italic' }}>Vi må forsvare det vi har bygget opp.</p>
      </div>
    </Glass>
  )
}
  ...
  return (
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 800, marginBottom: 32, lineHeight: 1.2 }}>Hvorfor er det bra for Norge at forskjellene mellom fattig og rik er små?</h2>
        <p style={{ ...bodyText, fontSize: 20 }}>Tenk på hvordan små forskjeller påvirker tillit, samarbeid og livskvalitet i samfunnet.</p>
      </div>
    </Glass>
  )
}

export default function ParteneArbeidslivetPresentation() {
  ...
  function startLiveSession() {
    ...
    localStorage.setItem(`adventure-live-session-${pin}`, JSON.stringify({
      ...
      status: 'active',
      presentationName: 'Partene i arbeidslivet',
    }))
    setLivePin(pin)
