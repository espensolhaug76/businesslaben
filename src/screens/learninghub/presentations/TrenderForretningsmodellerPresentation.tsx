...
const TERMS: Record<string, string> = {
  'Megatrender': 'Store, langsiktige trender som påvirker hele samfunnet over 10–30 år. Eks: digitalisering, demografiske endringer, sirkulær økonomi.',
  'Sirkulærøkonomi': 'Et system der ressurser holdes i omløp lengst mulig gjennom gjenbruk, reparasjon og resirkulering — i stedet for "ta-lag-kast".',
  'Abonnementsmodellen': 'Forretningsmodell der kunden betaler en fast, gjentakende avgift for kontinuerlig tilgang til et produkt eller en tjeneste.',
  'Delingsøkonomi': 'Utnytter underutnyttede ressurser ved å formidle dem mellom de som har og de som trenger — via digitale plattformer.',
  'Tredoble bunnlinjen': 'Rammeverk som måler bedriftens resultater på tre dimensjoner: Profit (økonomi), People (sosial) og Planet (miljø).',
  'Grønnvasking': 'Å fremstille seg som mer bærekraftig enn man faktisk er gjennom markedsføring, uten reelle endringer i forretningsmodellen.',
  'Åpenhetsloven': 'Norsk lov (2022) som pålegger større virksomheter å utføre aktsomhetsvurderinger knyttet til menneskerettigheter i leverandørkjeden.',
  'Verdikjedepress': 'Bruk av markedsmakt til å stille bærekraftskrav oppover og nedover i hele forsyningskjeden.',
}

const QUIZ_SLIDES: QuizQuestion[] = [
  {
    question: 'Hva skiller en megatrend fra en vanlig trend?',
    options: [
      'En megatrend er en langsiktig, global kraft som omformer samfunn og næringsliv over tiår',
      'En megatrend varer bare noen måneder lenger enn en normal trend',
      'En megatrend er kun relevant for store multinasjonale selskaper',
      'Megatrender er enkle å tilpasse seg til fordi de er forutsigbare',
    ],
    correct: 0,
    timeSeconds: 45,
  },
  {
    question: 'Hva er den tredoble bunnlinjen (Triple Bottom Line)?',
    options: [
      'Et regnskapsformat med tre kolonner for inntekter',
      'Et rammeverk som måler resultater på Profit, People og Planet',
      'En modell for å beregne tre ulike prisstrategier',
      'En metode for å dele overskudd mellom tre parter',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    question: 'Hva er forskjellen mellom sirkulærøkonomi og lineær økonomi?',
    options: [
      'Sirkulærøkonomi handler om å selge i sirkler, lineær om rett linje',
      'Lineær økonomi holder ressurser i omløp, sirkulær kaster dem',
      'Sirkulærøkonomi designer produkter for gjenbruk; lineær bruker ressurser én gang og kaster',
      'Det er ingen praktisk forskjell — begge er bærekraftige',
    ],
    correct: 2,
    timeSeconds: 45,
  },
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: 'clamp(3rem, 10vw, 8rem)', fontWeight: 800, marginBottom: 32, letterSpacing: '-0.03em', lineHeight: 1.05 }}>
        Trender, forretningsmodeller<br />
        <span style={{ color: '#38bdf8', fontStyle: 'italic' }}>og bærekraft</span>
      </h1>
      <p style={{ fontSize: 22, color: '#94a3b8', marginBottom: 48, maxWidth: 600, margin: '0 auto 48px', fontWeight: 300, lineHeight: 1.6 }}>
        Fra megatrender til sirkulær økonomi og tredobbel bunnlinje.
      </p>
      {_isLive ? (
...
function Slide1({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul 6 – Trender og forretningsmodeller</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Megatrender" onShow={onShow} /> som driver næringslivet
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 12 }}>
              <strong style={{ color: '#f1f5f9' }}>Digitalisering:</strong> Endrer kundeadferd, distribusjon og forretningsmodeller.
            </li>
            <li style={{ ...bodyText, marginBottom: 12 }}>
              <strong style={{ color: '#f1f5f9' }}>Demografiske endringer:</strong> Aldrende befolkning, urbanisering og generasjonsskifter.
            </li>
            <li style={bodyText}>
              <strong style={{ color: '#f1f5f9' }}>Sirkulær økonomi:</strong> Fra "ta-lag-kast" til ressurser i omløp.
            </li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=800&q=80" alt="Megatrender" />
      </div>
    </Glass>
  )
}
...
function Slide2({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1532601224476-15c79f2f7a51?auto=format&fit=crop&w=800&q=80" alt="Sirkulærøkonomi" />
        <div>
          <SlideLabel>Ny økonomimodell</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Sirkulærøkonomi" onShow={onShow} /> – ressurser i omløp
          </h2>
          <p style={{ ...bodyText, marginBottom: 12 }}>
            <strong style={{ color: '#f1f5f9' }}>Lineær økonomi:</strong> Råmaterialer → produksjon → bruk → avfall.
          </p>
          <p style={bodyText}>
            <strong style={{ color: '#f1f5f9' }}>Sirkulær økonomi:</strong> Produkter designet for reparasjon, deling, oppgradering og resirkulering.
          </p>
        </div>
      </div>
    </Glass>
...
function Slide3({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Forretningsmodell</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Abonnementsmodellen" onShow={onShow} /> – forutsigbar inntekt
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>I stedet for engangs-varesalg selger bedriften tilgang til en tjeneste for en fast, gjentakende betaling.</p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1.5rem' }}>
            <ul style={listStyle}>
              <li style={{ ...bodyText, color: '#f1f5f9' }}>Forutsigbar inntekt for bedriften</li>
              <li style={{ ...bodyText, color: '#f1f5f9' }}>Lavere kundefrafall (churn)</li>
              <li style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>Eks: Netflix, Spotify, matboks-levering</li>
            </ul>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&w=800&q=80" alt="Abonnement" />
      </div>
    </Glass>
  )
}
...
function Slide4({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=800&q=80" alt="Delingsøkonomi" />
        <div>
          <SlideLabel>Plattformøkonomi</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Delingsøkonomi" onShow={onShow} /> – utnytt det uutnyttede
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            "Airbnb er verdens største hotellkjede uten å eie ett eneste rom."
          </p>
          <p style={bodyText}>
            Digitale plattformer formidler underutnyttede ressurser mellom de som har og de som trenger — mot betaling.
          </p>
        </div>
      </div>
    </Glass>
...
function Slide5({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Bærekraftsstrategi</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Tredoble bunnlinjen" onShow={onShow} /> – mennesker, planet, profit
          </h2>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1.5rem' }}>
            <ul style={listStyle}>
              <li style={{ ...bodyText, color: '#f1f5f9' }}><strong>Profit:</strong> Finansiell lønnsomhet</li>
              <li style={{ ...bodyText, color: '#f1f5f9' }}><strong>People:</strong> Ansatte, leverandørkjede, lokalsamfunn</li>
              <li style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}><strong>Planet:</strong> Klimaavtrykk og ressursbruk</li>
            </ul>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1532601224476-15c79f2f7a51?auto=format&fit=crop&w=800&q=80" alt="Bærekraft" />
      </div>
    </Glass>
  )
}
...
function Slide6({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80" alt="Voice bærekraft" />
        <div>
          <SlideLabel>Eksempel: Tekstil</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Voice – tekstil møter bærekraft
          </h2>
          <p style={{ ...bodyText, marginBottom: 12 }}>
            <strong style={{ color: '#f1f5f9' }}>Utgangspunktet:</strong> Tradisjonell klesforhandler med lineær modell.
          </p>
          <p style={{ ...bodyText, marginBottom: 12 }}>
            <strong style={{ color: '#f1f5f9' }}>Endringen:</strong> Integrerte tilbakekjøp, gjenbruk og produsentansvar.
          </p>
          <p style={bodyText}>
            <strong style={{ color: '#f1f5f9' }}>Driveren:</strong> Unge forbrukere forventer bærekraft og belønner det med lojalitet.
          </p>
        </div>
      </div>
    </Glass>
...
function Slide7({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Eksempel: Dagligvare</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            NorgesGruppen – <Term word="Verdikjedepress" onShow={onShow} />
          </h2>
          <p style={{ ...bodyText, marginBottom: 12 }}>
            43 % av norsk dagligvaresalg — leverandørene MÅ forholde seg til dem.
          </p>
          <p style={bodyText}>
            1 400 leverandører utfordres til å kutte utslipp og redusere matsvinn. Samlet effekt er langt større enn NorgesGruppen alene.
          </p>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80" alt="Verdikjede" />
      </div>
    </Glass>
  )
}
...
function Slide8({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=800&q=80" alt="Grønnvasking" />
        <div>
          <SlideLabel>Misforståelse</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Bærekraft er ikke bare klima – og pass opp for <Term word="Grønnvasking" onShow={onShow} />
          </h2>
          <p style={{ ...bodyText, marginBottom: 12 }}>
            <strong style={{ color: '#f1f5f9' }}>Myten:</strong> "Bærekraft = klimavern + resirkulering." Kun én av tre dimensjoner.
          </p>
          <p style={bodyText}>
            Forbrukertilsynet slår ned på udokumenterte bærekraftspåstander i markedsføringen.
          </p>
        </div>
      </div>
    </Glass>
    ...
    <Glass>
      <div style={twoCol}>
        <div>
          ...
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Åpenhetsloven" onShow={onShow} /> og Markedsføringsloven
          </h2>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1.5rem' }}>
            <ul style={listStyle}>
              <li style={{ ...bodyText, color: '#f1f5f9' }}><strong>Åpenhetsloven (2022):</strong> Aktsomhetsvurdering av menneskerettigheter i leverandørkjeden</li>
              <li style={{ ...bodyText, color: '#f1f5f9' }}><strong>Markedsføringsloven:</strong> Forbyr villedende bærekraftspåstander</li>
              <li style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>Bærekraft er ikke lenger frivillig — det er juridisk forpliktelse</li>
            </ul>
          </div>
        </div>
    ...
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 4rem)', fontWeight: 800, marginBottom: 32, lineHeight: 1.2 }}>
          Hvilken megatrend påvirker bransjen du vil jobbe i mest — og hva gjør de ledende aktørene for å tilpasse seg?
        </h2>
        <p style={{ ...bodyText, fontSize: 20 }}>
          Bedrifter som forstår og tilpasser seg megatrender er bedre rustet for fremtiden. Tilpasning er ikke valgfritt — det er overlevelse.
        </p>
      </div>
    </Glass>
  )
...
export default function TrenderForretningsmodellerPresentation() {
  ...
  function startLiveSession() {
    ...
    localStorage.setItem(`adventure-live-session-${pin}`, JSON.stringify({
      ...
      status: 'active',
      presentationName: 'Trender og forretningsmodeller',
    }))
    setLivePin(pin)
