...
const TERMS: Record<string, string> = {
  'Markedsføringskampanje': 'En koordinert, tidsbegrenset innsats for å oppnå et spesifikt markedsføringsmål med klart budsjett og tidsramme.',
  'Forbrukeratferd': 'Studiet av prosessene folk gjennomgår når de velger, kjøper, bruker og kvitter seg med produkter og tjenester.',
  'Referansegruppe': 'Mennesker vi identifiserer oss med og som påvirker våre holdninger og kjøpsatferd, f.eks. venner og familie.',
  'Influensermarkedsføring': 'Markedsføring som bruker enkeltpersoner med en dedikert tilhengerskare til å promotere produkter og tjenester.',
  'Konverteringsrate': 'Andelen av eksponerte brukere som utfører ønsket handling, f.eks. kjøp, registrering eller klikk.',
  'ROAS': 'Return On Ad Spend — inntekter generert per krone brukt på annonser. ROAS = Inntekter / Annonsebudsjett.',
  'A/B-testing': 'Metode der to versjoner av en annonse kjøres parallelt for å avgjøre hvilken som konverterer best.',
  'Mikromålretting': 'Teknologi som lar annonsører nå svært spesifikke målgrupper basert på alder, sted, interesser og atferd.',
  'Forfengelighetsmetrikk': 'Målinger som likes, følgere og visninger som ser imponerende ut men ikke nødvendigvis påvirker bunnlinjen.',
  'Markedsføringsloven': 'Norsk lov som regulerer all kommersiell kommunikasjon, inkludert krav om tydelig merking av betalt innhold.',
}

const QUIZ_SLIDES: QuizQuestion[] = [
  {
    question: 'Hva er ROAS, og hva betyr en ROAS på 4?',
    options: [
      'Return On Ad Spend — for hver investerte krone fikk bedriften 4 kr i inntekter',
      'Rate Of Ad Success — kampanjen nådde 4 % av målgruppen',
      'Revenue Over Actual Sales — salget økte med 4 %',
      'Return On Average Spend — gjennomsnittsordre er 4 ganger budsjettet',
    ],
    correct: 0,
    timeSeconds: 45,
  },
  {
    question: 'Hva skiller en markedsføringskampanje fra løpende markedsføring?',
    options: [
      'En kampanje er alltid dyrere og bruker mer avansert teknologi',
      'En kampanje er tidsbegrenset med et spesifikt mål og koordinert innsats',
      'En kampanje bruker kun sosiale medier, løpende markedsføring bruker TV',
      'En kampanje ledes alltid av et eksternt reklamebyrå',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    question: 'En influenser har 5 000 følgere og 10 % engasjementsrate. En annen har 500 000 følgere og 0,4 % engasjementsrate. Hvem er mest kostnadseffektiv for en nisjeproduktlansering?',
    options: [
      'Den med 500 000 følgere — rekkevidde er viktigst',
      'Den med 5 000 følgere — høy engasjementsrate i nisjen er mer verdifull',
      'De er like verdifulle',
      'Ingen av dem — bruk TV-reklame i stedet',
    ],
    correct: 1,
    timeSeconds: 45,
  },
...
function Slide1({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul – Markedsføringskampanjer</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Hva er en <Term word="Markedsføringskampanje" onShow={onShow} />?
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 12 }}>
              <strong style={{ color: '#f1f5f9' }}>Tidsbegrenset:</strong> Har en klar start og slutt.
            </li>
            <li style={{ ...bodyText, marginBottom: 12 }}>
              <strong style={{ color: '#f1f5f9' }}>Spesifikt mål:</strong> F.eks. øke salg med 20 % eller lansere nytt produkt.
            </li>
            <li style={bodyText}>
              <strong style={{ color: '#f1f5f9' }}>Koordinert:</strong> Konsistent budskap på tvers av kanaler med definert budsjett.
            </li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=800&q=80" alt="Markedsføringskampanje" />
      </div>
    </Glass>
  )
}
...
function Slide2({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80" alt="Forbrukeratferd" />
        <div>
          <SlideLabel>Kjøpspsykologi</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Forbrukeratferd" onShow={onShow} /> — Hvorfor kjøper folk?
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}>
              <strong style={{ color: '#f1f5f9' }}>Kjøpsprosessen:</strong> Behovserkjennelse → Søk → Vurdering → Kjøp → Ettersalg
            </li>
            <li style={{ ...bodyText, marginBottom: 8 }}>
              <strong style={{ color: '#f1f5f9' }}>Interne faktorer:</strong> Motivasjon, holdninger, livsstil, verdier
            </li>
            <li style={bodyText}>
              <strong style={{ color: '#f1f5f9' }}>Sosiale faktorer:</strong> <Term word="Referansegruppe" onShow={onShow} />, kultur, sosial klasse
            </li>
          </ul>
        </div>
      </div>
...
function Slide3({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Troverdige tredjeparter</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Influensermarkedsføring" onShow={onShow} />
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Mega-influensere:</strong> Over 1M følgere. Stor rekkevidde, lav engasjementsrate.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Makro-influensere:</strong> 100k–1M. God balanse rekkevidde/engasjement.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Mikro-influensere:</strong> 1k–100k. Høy engasjementsrate, svært troverdig i nisjen.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}>Nano-influensere:</strong> Under 1 000. Lokal troverdighet, lav kostnad.</li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80" alt="Influenser" />
      </div>
    </Glass>
  )
}
...
function Slide4({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80" alt="Kanalvalg" />
        <div>
          <SlideLabel>Kanalstrategi</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Riktig budskap på riktig kanal
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Google Ads:</strong> Treffer aktivt søkende — svært høy kjøpsintensjon.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Instagram/Facebook:</strong> Bred demografi, sterk visuell kommunikasjon.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>TikTok:</strong> Under 30, høy engasjementsrate, viral potensial.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}>E-post:</strong> Eksisterende kunder, personalisering, høy <Term word="ROAS" onShow={onShow} />.</li>
          </ul>
        </div>
      </div>
    </Glass>
...
function Slide5({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Datadrevet markedsføring</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Målretting og evaluering
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}>
              <strong style={{ color: '#f1f5f9' }}><Term word="Mikromålretting" onShow={onShow} />:</strong> Målrett på alder, sted, interesser og atferd.
            </li>
            <li style={{ ...bodyText, marginBottom: 8 }}>
              <strong style={{ color: '#f1f5f9' }}><Term word="A/B-testing" onShow={onShow} />:</strong> Test to varianter parallelt — behold den som konverterer best.
            </li>
            <li style={bodyText}>
              <strong style={{ color: '#f1f5f9' }}><Term word="Konverteringsrate" onShow={onShow} />:</strong> Andelen som utfører ønsket handling av de eksponerte.
            </li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80" alt="Dataanalyse" />
      </div>
    </Glass>
  )
}
...
function Slide6({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=800&q=80" alt="Hurtigruten" />
        <div>
          <SlideLabel>Case: Hurtigruten</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Google Ads internasjonalt
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Hurtigruten annonserer på "Polarlichter Norwegen" for tyske turister — på <strong style={{ color: '#f1f5f9' }}>tysk, ikke norsk</strong>.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>
              Lokaliserte annonser på morsmålet konverterer bedre og koster mindre per klikk.
            </p>
          </div>
        </div>
      </div>
...
function Slide7({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Case: XXL Sport</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Segmentbasert kanalstrategi
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            "Back to school"-kampanjer med ulik kanalstrategi for to segmenter:
          </p>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Facebook for foreldre:</strong> Fokus på pris og praktisk innkjøp.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}>TikTok for ungdom:</strong> Fokus på stil, community og viral video.</li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80" alt="XXL Sport" />
      </div>
    </Glass>
  )
}
...
function Slide8({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80" alt="Metrikk" />
        <div>
          ...
          <p style={{ ...bodyText, marginBottom: 16 }}>
            <Term word="Forfengelighetsmetrikk" onShow={onShow} /> som likes og følgere ser bra ut, men sier ingenting om salgspåvirkning.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>
              Fokuser på: Kostnad per konvertering, <Term word="ROAS" onShow={onShow} /> og Customer Acquisition Cost.
            </p>
          </div>
        </div>
      </div>
    ...
    <Glass>
      <div style={twoCol}>
        <div>
          ...
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Markedsføringsloven" onShow={onShow} /> og reklameregler
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Skjult reklame er forbudt:</strong> Alt betalt innhold skal merkes med "Annonse".</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Influensere plikter å merke:</strong> Forbrukertilsynet håndhever dette aktivt.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}>Barnevern:</strong> Skjult markedsføring mot barn er strengt forbudt.</li>
          </ul>
        </div>
    ...
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 4rem)', fontWeight: 800, marginBottom: 32, lineHeight: 1.2 }}>
          En kampanje fikk 50 000 likes og 10 salg. En annen fikk 500 likes og 200 salg. Hvilken var mest effektiv — og hvorfor måler vi feil?
        </h2>
        <p style={{ ...bodyText, fontSize: 20 }}>
          Likes er ego-boost, ikke business-impact. Den sanne målestokken er alltid: hva kostet det, og hva fikk vi igjen?
        </p>
      </div>
    </Glass>
  )
...
export default function MarkedsforingskampanjerPresentation() {
  ...
  function startLiveSession() {
    ...
    localStorage.setItem(`adventure-live-session-${pin}`, JSON.stringify({
      ...
      status: 'active',
      presentationName: 'Markedsføringskampanjer',
    }))
    setLivePin(pin)
