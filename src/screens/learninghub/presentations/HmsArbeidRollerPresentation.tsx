...
const TERMS: Record<string, string> = {
  'Internkontroll': 'Systematisk og lovpålagt HMS-arbeid strukturert i fire trinn: forplikte, kartlegge, planlegge tiltak og følge opp. Gjentas kontinuerlig som en syklus.',
  'Verneombud': 'Demokratisk valgt representant som overvåker arbeidsmiljøet på vegne av arbeidstakerne. Kan umiddelbart stanse farlig arbeid uten å spørre leder.',
  'AMU': 'Arbeidsmiljøutvalget — lovpålagt organ i virksomheter med 50+ ansatte. Partssammensatt med representanter fra ledelse og ansatte.',
  'Avvik': 'Enhver hendelse der noe ikke gikk som planlagt — brudd på rutine, nestenulykke eller faktisk skade. Alle plikter å melde avvik.',
  'Medvirkningsplikt': 'Lovfestet plikt for alle ansatte til å bidra i HMS-arbeidet, bruke verneutstyr og melde fra om farer (Arbeidsmiljøloven § 2-3).',
  'Stansingsrett': 'Verneombudets juridiske rett til umiddelbart å stanse arbeid som er til fare for liv og helse, uten å spørre leder.',
  'ROS-analyse': 'Risiko- og sårbarhetsanalyse. Systematisk kartlegging av hva som kan gå galt, sannsynlighet og konsekvens. Kjernen i trinn 2 i internkontroll.',
  'Arbeidsmiljøloven': 'Norges viktigste velferdslov for arbeidslivet. Regulerer rettigheter og plikter for arbeidsgiver og arbeidstaker. Forkortet AML.',
}
...
const QUIZ_SLIDES: QuizQuestion[] = [
  {
    ...
    options: [
      'En gang i året sjekke at brannslukker er på plass',
      'En kontinuerlig prosess med kartlegging, planlegging, tiltak og oppfølging',
      'Å sende HMS-rapport til Arbeidstilsynet hvert år',
      'Å kjøpe verneutstyr til alle ansatte',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    ...
    options: [
      'Skrive en rapport som sendes til leder innen 30 dager',
      'Reparere reoloppsettet selv etter arbeidstid',
      'Umiddelbart stanse arbeid i det farlige området og varsle leder',
      'Ta bilde og legge det ut på intern chat for å skape bevissthet',
    ],
    correct: 2,
    timeSeconds: 45,
  },
  {
    ...
    options: [
      'Nei, ingen ble skadet så det er ikke nødvendig',
      'Ja, nestenulykker er svært verdifulle og skal alltid meldes',
      'Kun hvis det er en gjest og ikke en ansatt',
      'Bare hvis det skjer mer enn én gang',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: 'clamp(3rem, 10vw, 8rem)', fontWeight: 800, marginBottom: 32, letterSpacing: '-0.03em', lineHeight: 1.05 }}>
        HMS-roller og<br />
        <span style={{ color: '#38bdf8', fontStyle: 'italic' }}>internkontroll</span>
      </h1>
...
function Slide1({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>HMS-VG2 – Systematisk arbeid</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Internkontroll" onShow={onShow} /> — lovpålagt HMS
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Alle</strong> norske virksomheter med ansatte plikter et fungerende HMS-system.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Daglig leder</strong> har det øverste juridiske ansvaret.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}>Alle ansatte</strong> har medvirkningsplikt.</li>
          </ul>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem', marginTop: 20 }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700, textAlign: 'center' }}>HMS = Helse, Miljø og Sikkerhet</p>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?auto=format&fit=crop&w=800&q=80" alt="HMS-arbeid" />
      </div>
    </Glass>
  )
}
...
function Slide2({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&w=800&q=80" alt="Internkontroll syklus" />
        <div>
          <SlideLabel>De fire trinnene</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Internkontroll" onShow={onShow} />-syklusen
          </h2>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1.5rem' }}>
            <ul style={listStyle}>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>1. <strong>Forplikte</strong> — ansvar og formål fastslås</li>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>2. <strong>Kartlegge</strong> — <Term word="ROS-analyse" onShow={onShow} /> av risiko</li>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>3. <strong>Planlegge tiltak</strong> — handlingsplan med frister</li>
              <li style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>4. <strong>Følge opp</strong> — vernerunder og avvik</li>
            </ul>
          </div>
        </div>
      </div>
...
function Slide3({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Lederansvar</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Daglig leder — det kan ikke delegeres
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Daglig leder bærer det øverste juridiske ansvaret for HMS. Dette kan <strong style={{ color: '#f1f5f9' }}>ikke</strong> overføres til verneombudet eller en HMS-koordinator.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#94a3b8', fontStyle: 'italic' }}>
              "Du kan delegere oppgaver, men du kan aldri delegere juridisk ansvar."
            </p>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?auto=format&fit=crop&w=800&q=80" alt="Lederansvar HMS" />
      </div>
    </Glass>
  )
}
...
function Slide4({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&w=800&q=80" alt="Verneombud" />
        <div>
          <SlideLabel>Arbeidstakernes representant</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Verneombud" onShow={onShow} />
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}>Demokratisk valgt av og blant arbeidstakerne.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}>Har <Term word="Stansingsrett" onShow={onShow} /> — kan umiddelbart stanse farlig arbeid.</li>
            <li style={bodyText}>Plikter <strong style={{ color: '#f1f5f9' }}>ikke</strong> å utbedre problemer — det er alltid lederens oppgave.</li>
          </ul>
        </div>
      </div>
    </Glass>
...
function Slide5({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Lovpålagt organ</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="AMU" onShow={onShow} /> — Arbeidsmiljøutvalget
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Lovpålagt i virksomheter med <strong style={{ color: '#f1f5f9' }}>50 eller flere ansatte</strong>. Partssammensatt organ med lik representasjon fra ledelse og ansatte.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700, textAlign: 'center' }}>10+ ansatte = verneombud | 50+ ansatte = AMU</p>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?auto=format&fit=crop&w=800&q=80" alt="AMU møte" />
      </div>
    </Glass>
  )
}
...
function Slide6({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&w=800&q=80" alt="Avvikssystem" />
        <div>
          <SlideLabel>Operativt HMS-arbeid</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Avvik" onShow={onShow} />ssystemet — lær av feil
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Alle avvik skal meldes — ikke bare alvorlige hendelser, men også nestenulykker. En nestenulykke er en <strong style={{ color: '#f1f5f9' }}>gave</strong>: den viser at noe er feil uten at noen ble skadet.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#94a3b8', fontStyle: 'italic', textAlign: 'center' }}>
              "Et avvik som ikke meldes, skjer om igjen."
            </p>
          </div>
        </div>
      </div>
...
function Slide7({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Case — Asko</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            HMS i lagerhverdagen
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Hos Asko (NorgesGruppens distribusjonskjede) oppdager <Term word="Verneombud" onShow={onShow} /> ustabile reoler og skriver avviksmelding umiddelbart. Leder er forpliktet til å utbedre.
          </p>
          <p style={bodyText}>
            En ansatt som nekter å bruke verneskorer bryter sin <Term word="Medvirkningsplikt" onShow={onShow} /> etter Arbeidsmiljøloven § 2-3.
          </p>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?auto=format&fit=crop&w=800&q=80" alt="Lager HMS" />
      </div>
    </Glass>
  )
}
...
function Slide8({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&w=800&q=80" alt="Misforståelse HMS" />
        <div>
          <SlideLabel>Vanlig misforståelse</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Verneombudet er ikke HMS-sjef
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#ef4444' }}>Myten:</strong> "Verneombudet er HMS-ansvarlig."</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#4ade80' }}>Realiteten:</strong> Verneombudet overvåker og rapporterer — utbedringsansvar tilhører alltid leder.</li>
            <li style={bodyText}><strong style={{ color: '#38bdf8' }}>Styrken:</strong> Verneombudet kan umiddelbart stanse farlig arbeid — unik juridisk rettighet.</li>
          </ul>
        </div>
      </div>
    </Glass>
    ...
    <Glass>
      <div style={twoCol}>
        <div>
          ...
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Arbeidsmiljøloven" onShow={onShow} /> og IK-forskriften
          </h2>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1.5rem' }}>
            <ul style={listStyle}>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>AML kap. 3 → systematisk HMS-arbeid</li>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>AML kap. 6 → verneombudsordningen</li>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>AML kap. 7 → AMU</li>
              <li style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>IK-forskriften → dokumentasjon og prosedyrer</li>
            </ul>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?auto=format&fit=crop&w=800&q=80" alt="Lovverk HMS" />
      </div>
    </Glass>
  )
}
    ...
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 4rem)', fontWeight: 800, marginBottom: 32, lineHeight: 1.2 }}>
          Hva ville du gjort om du oppdaget en umiddelbar fare og leder ikke tok det seriøst?
        </h2>
        <p style={{ ...bodyText, fontSize: 20 }}>
          Du har juridiske rettigheter i denne situasjonen. Verneombudet kan stanse arbeidet. Arbeidstilsynet kan kontaktes. Avvik kan meldes anonymt. Kunnskap gir handlingsrom.
        </p>
      </div>
    </Glass>
  )
...
export default function HmsArbeidRollerPresentation() {
  ...
  function startLiveSession() {
    ...
    localStorage.setItem(`adventure-live-session-${pin}`, JSON.stringify({
      ...
      status: 'active',
      presentationName: 'HMS-roller og internkontroll',
    }))
    setLivePin(pin)
