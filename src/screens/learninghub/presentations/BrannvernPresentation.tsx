...
const TERMS: Record<string, string> = {
  'Branntrekanten': 'Det grunnleggende fysiske prinsippet bak all brann: oksygen + varme + brennbart materiale. Fjern én side og brannen slukner.',
  'Varsle – Redde – Slokke': 'Den universelle handlingsregelen i norsk brannvern. Alltid i denne rekkefølgen — varsle først, hjelp folk ut, slokke til slutt.',
  'Rømningsvei': 'Forhåndsdefinert rute fra alle rom til samlingsplass utenfor bygget. Må alltid være fri og tydelig merket.',
  'CO2-slukker': 'Brannslukkingsapparat som fjerner oksygen fra brannen. Best egnet mot elektrisk brann og elektronikk — skader ikke utstyret.',
  'Pulverslukker': 'Allsidig brannslukkingsapparat mot papir, treverk, bensin og elektrisk brann (klasse A, B, C og E).',
  'Internkontroll': 'Systematisk og lovpålagt HMS-arbeid i virksomheten. Brannvern er en sentral del av internkontrollen.',
  'Evakueringsøvelse': 'Regelmessig gjennomføring av evakuering fra bygget. Lovpålagt minst én gang per år i alle virksomheter.',
  'Nødutgang': 'Dør med grønt nødskilt som alltid skal åpne innenfra uten nøkkel. Må aldri blokkeres av noe som helst.',
  'Samlingsplass': 'Fast punkt utenfor bygget der alle møter etter evakuering. Gjør det mulig å telle hvem som er kommet ut.',
}
...
const QUIZ_SLIDES: QuizQuestion[] = [
  {
    ...
    options: [
      'Brennbart materiale fjernes',
      'Varme — blåsingen avkjøler flammen under tenntemperatur',
      'Oksygen tilfører mer luft og slukker dermed',
      'Ingen side — det er bare flaks',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    ...
    options: [
      'Henter brannslukker og prøver å slokke',
      'Løper ut og venter på brannvesenet',
      'Utløser brannalarmen, varsler kolleger og hjelper alle ut',
      'Ringer sjefen for å spørre hva du skal gjøre',
    ],
    correct: 2,
    timeSeconds: 45,
  },
  {
    ...
    options: [
      'Vann — kjøler ned utstyret effektivt',
      'Skum — dekker brannen og kveler den',
      'CO2 — kveler brannen uten å lede strøm',
      'Brannteppe — legg over sikringsskapet',
    ],
    correct: 2,
    timeSeconds: 45,
  },
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <p style={{ fontSize: 22, color: '#94a3b8', marginBottom: 48, maxWidth: 600, margin: '0 auto 48px', fontWeight: 300, lineHeight: 1.6 }}>
        Branntrekanten, Varsle-Redde-Slokke og ansvar i servicebransjen
      </p>
      {_isLive ? (
...
function Slide1({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>HMS-VG2 – Brannvern</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Branntrekanten" onShow={onShow} /> — grunnlaget for all slokking
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Oksygen:</strong> Tilgjengelig luft er nødvendig for forbrenning.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Varme:</strong> Tenntemperatur må nås og opprettholdes.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}>Brennbart materiale:</strong> Papir, tekstil, olje eller gass.</li>
          </ul>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem', marginTop: 20 }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700, textAlign: 'center' }}>Fjern én side → brannen slukner</p>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80" alt="Branntrekanten" />
      </div>
    </Glass>
  )
}
...
function Slide2({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=80" alt="Brannvarsling" />
        <div>
          <SlideLabel>Handlingsregel</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Varsle – Redde – Slokke" onShow={onShow} />
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>VARSLE:</strong> Utløs brannalarmen og ring 110 umiddelbart.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>REDDE:</strong> Hjelp alle ut. Prioriter sårbare personer.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}>SLOKKE:</strong> Kun hvis brannen er liten og ruten til nødutgang er klar.</li>
          </ul>
        </div>
      </div>
    </Glass>
...
function Slide3({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Slokkemidler</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="CO2-slukker" onShow={onShow} /> og <Term word="Pulverslukker" onShow={onShow} />
          </h2>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1.5rem' }}>
            <ul style={listStyle}>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>CO2 → elektrisk utstyr og elektronikk</li>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>Pulver → allsidig (A, B, C og E)</li>
              <li style={{ ...bodyText, color: '#f1f5f9', marginBottom: 6 }}>Skum → væskebrann (ALDRI mot elektrisk)</li>
              <li style={{ ...bodyText, color: '#ef4444', fontWeight: 700 }}>Vann på olje = eksplosjon. Aldri!</li>
            </ul>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80" alt="Slokkemidler" />
      </div>
    </Glass>
  )
}
...
function Slide4({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&w=800&q=80" alt="Rømningsveier" />
        <div>
          <SlideLabel>Sikkerhet</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Rømningsvei" onShow={onShow} /> og <Term word="Nødutgang" onShow={onShow} />
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}>Alle rømningsveier skal alltid være <strong style={{ color: '#f1f5f9' }}>frie og merket</strong>.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}>Nødutganger åpner innenfra <strong style={{ color: '#f1f5f9' }}>uten nøkkel</strong> — alltid.</li>
            <li style={bodyText}>Lukk dører bak deg under evakuering — dører holder røyk og flammer tilbake.</li>
          </ul>
        </div>
      </div>
    </Glass>
...
function Slide5({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Øvelse</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Evakueringsøvelse" onShow={onShow} /> og <Term word="Samlingsplass" onShow={onShow} />
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Brannøvelse er lovpålagt <strong style={{ color: '#f1f5f9' }}>minst én gang per år</strong> i alle virksomheter. Øvelsen evalueres etterpå for å lære av svakheter.
          </p>
          <p style={bodyText}>
            Samlingsplassen er et fast punkt utenfor bygget der alle møter, slik at du kan telle hvem som er kommet ut.
          </p>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?auto=format&fit=crop&w=800&q=80" alt="Brannøvelse" />
      </div>
    </Glass>
  )
}
...
function Slide6({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80" alt="Kjøkkenbrann" />
        <div>
          <SlideLabel>Case — Restaurantkjøkken</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Olje og feil valg
          </h2>
          <div style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: 16, padding: '1.5rem', marginBottom: 16 }}>
            <p style={{ ...bodyText, color: '#fca5a5', fontWeight: 700 }}>Vann på brennende olje = eksplosjon!</p>
          </div>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}>1. Slå av varmen (fjern varme-siden)</li>
            <li style={{ ...bodyText, marginBottom: 8 }}>2. Legg brannteppe forsiktig over gryten (kvel brannen)</li>
            <li style={bodyText}>3. Varsle og evakuer</li>
          </ul>
        </div>
      </div>
    </Glass>
...
function Slide7({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Case — Cubus-butikken</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Ansvar i butikkhverdagen
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Butikksjefen er juridisk ansvarlig for at ingen paller eller kasser blokkerer <Term word="Nødutgang" onShow={onShow} /> — selv midt i varemottak.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#94a3b8', fontStyle: 'italic' }}>
              "Fem minutter" foran nødutgangen har lav sannsynlighet for brann — men katastrofal konsekvens om det skjer.
            </p>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=80" alt="Butikk brannvern" />
      </div>
    </Glass>
  )
}
...
function Slide8({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&w=800&q=80" alt="Lovverk brannvern" />
        <div>
          ...
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}>Alle virksomheter er <strong style={{ color: '#f1f5f9' }}>lovpålagt</strong> å ha brannforebyggende tiltak.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}>Lokalt brannvesen kan gjennomføre <strong style={{ color: '#f1f5f9' }}>uanmeldte tilsyn</strong>.</li>
            <li style={bodyText}>Brudd kan medføre bøter, pålegg og midlertidig <strong style={{ color: '#f1f5f9' }}>stengning</strong>.</li>
          </ul>
        </div>
      </div>
    </Glass>
    ...
    <Glass>
      <div style={twoCol}>
        <div>
          ...
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#ef4444' }}>Myte:</strong> "Alle brannslokkere er like." — <strong style={{ color: '#4ade80' }}>Feil</strong>, de er svært ulike.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#ef4444' }}>Myte:</strong> "Jeg redder laptopen først." — <strong style={{ color: '#4ade80' }}>Feil</strong>, menneskeliv alltid foran ting.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#ef4444' }}>Myte:</strong> "Nødutgangen kan låses for sikkerhet." — <strong style={{ color: '#4ade80' }}>Feil</strong>, alltid ulåst innenfra.</li>
            <li style={bodyText}><strong style={{ color: '#ef4444' }}>Myte:</strong> "Røyk er bare for lungene." — <strong style={{ color: '#4ade80' }}>Feil</strong>, 80 % av branndødsfall skyldes røyk.</li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?auto=format&fit=crop&w=800&q=80" alt="Brannmisforståelser" />
      </div>
    </Glass>
  )
}
    ...
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 4rem)', fontWeight: 800, marginBottom: 32, lineHeight: 1.2 }}>
          Brannalarm går NÅ — hva gjør du de neste 60 sekundene?
        </h2>
        <p style={{ ...bodyText, fontSize: 20 }}>
          Tenk igjennom: Hvilken vei går du? Hvem varsler du? Hvem teller folk ut? Er rømningsveien fri? Er du klar til å handle uten å tenke?
        </p>
      </div>
    </Glass>
  )
...
export default function BrannvernPresentation() {
