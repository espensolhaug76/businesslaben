...
const TERMS: Record<string, string> = {
  'Forbrukertilsynet': 'Statlig organ som passer på at markedsføring følger loven og at forbrukerne ikke blir lurt.',
  'God markedsføringsskikk': 'Standard for etisk og lovlig markedsføring. Forbyr diskriminerende, manipulerende eller villedende reklame.',
  'Retusjert reklame': 'Bilder som er digitalt redigert. Slik reklame må merkes med et eget symbol i Norge.',
  'Skjult reklame': 'Markedsføring som ikke er tydelig merket som reklame. Ulovlig etter markedsføringsloven.',
  'Angrerettloven': 'Loven som gir deg 14 dagers angrefrist når du handler på nett eller utenfor butikk.',
  'Falske førpriser': 'Å oppgi en høyere "før-pris" som varen aldri har hatt, for å få rabatten til å virke større. Ulovlig.',
  'Opt-in': 'At kunden aktivt har sagt ja til å motta reklame. Påkrevd før du kan sende direkte markedsføring.',
}
const QUIZ_SLIDES: QuizQuestion[] = [
  {
    question: 'Hvilken myndighet håndhever Markedsføringsloven i Norge?',
    options: [
      'Politiet og påtalemyndigheten',
      'Skattemyndighetene og Skatteetaten',
      'Forbrukertilsynet',
      'Arbeidstilsynet og NAV',
    ],
    correct: 2,
    timeSeconds: 45,
  },
  {
    ...
    options: [
      'Reklame som er synlig men svært liten i format',
      'Markedsføring som ikke er tydelig merket som reklame',
      'Gratis markedsføring via word-of-mouth',
      'Digital målrettet reklame på sosiale medier',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    question: 'Hva gir Angrerettloven norske forbrukere rett til ved netthandel?',
    options: [
      '30 dagers ubetinget returrett på alle varer',
      '7 dagers returrett fra leveringsdato',
      '14 dagers angrefrist fra mottak av varen',
      'Livstids garanti på alle kjøpte produkter',
    ],
    correct: 2,
    timeSeconds: 45,
  },
  {
    question: 'Hva er opt-in i markedsføring?',
    options: [
      'En metode for å avmelde seg fra reklamelister',
      'At kunden aktivt har samtykket til å motta markedsføring',
      'En type betalt annonsering på sosiale medier',
      'En teknisk løsning for å filtrere spam-e-post',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    question: 'Hva er falske førpriser og hvorfor er det ulovlig?',
    options: [
      'Å bruke historiske priser i reklame, noe som er lov i Norge',
      'Å oppgi en høyere "før-pris" varen aldri har hatt, for å få rabatten til å virke større',
      'Å sette fremtidige priser lavere for å stimulere forhåndskjøp',
      'Å bruke konkurrentenes priser som sammenligningsgrunnlag i reklame',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: 'clamp(3rem, 10vw, 8rem)', fontWeight: 800, marginBottom: 32, letterSpacing: '-0.03em', lineHeight: 1.05 }}>
        Regelverk<br /><span style={{ color: '#38bdf8', fontStyle: 'italic' }}>for markedsføring</span>
      </h1>
      <p style={{ fontSize: 22, color: '#94a3b8', marginBottom: 48, maxWidth: 600, margin: '0 auto 48px', fontWeight: 300, lineHeight: 1.6 }}>Modul 9 – Lover, regler og etikk som styrer hvordan bedrifter får lov til å reklamere.</p>
...
function Slide1({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80" alt="Lov og regelverk" />
        <div>
          <SlideLabel>Modul 9 – Slide 1</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}><Term word="Forbrukertilsynet" onShow={show} /> – Politi for reklame</h2>
          <p style={bodyText}>De passer på at ingen bedrifter lurer kundene. De kan gi store bøter til de som bryter loven.</p>
        </div>
      </div>
    </Glass>
  )
...
function Slide2({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul 9 – Slide 2</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}><Term word="God markedsføringsskikk" onShow={show} /></h2>
          <p style={bodyText}>Du har ikke lov til å bruke reklame som er frekk, diskriminerende eller spiller på usikkerhet (f.eks. kroppspress). All <Term word="Retusjert reklame" onShow={show} /> må merkes med et eget symbol.</p>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1557838923-2985c318be48?auto=format&fit=crop&w=800&q=80" alt="Markedsføring" />
      </div>
    </Glass>
  )
}
...
function Slide3({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?auto=format&fit=crop&w=800&q=80" alt="Sosiale medier og influencer" />
        <div>
          <SlideLabel>Modul 9 – Slide 3</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}><Term word="Skjult reklame" onShow={show} /></h2>
          <p style={bodyText}>Hvis en influencer viser frem en ny energidrikk uten å skrive "Reklame", er det ulovlig. Kunden skal alltid vite når noen får betalt for å si noe pent.</p>
        </div>
      </div>
    </Glass>
  )
...
function Slide4({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul 9 – Slide 4</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}><Term word="Angrerettloven" onShow={show} /> – Angrefristen</h2>
          <p style={bodyText}>Når du handler på nett, har du alltid 14 dager på å ombestemme deg. Du trenger ikke en grunn, du kan bare sende varen tilbake.</p>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=800&q=80" alt="Netthandel" />
      </div>
    </Glass>
  )
}
...
function Slide5({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80" alt="Prismerking" />
        <div>
          <SlideLabel>Modul 9 – Slide 5</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}>Prismerking og <Term word="Falske førpriser" onShow={show} /></h2>
          <p style={bodyText}>Det er ulovlig å skrive "Før 1000,- Nå 500,-" hvis varen aldri har kostet 1000 kr. Det kalles falske førpriser.</p>
        </div>
      </div>
    </Glass>
  )
  ...
  return (
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        <SlideLabel>Modul 9 – Slide 6 – Case</SlideLabel>
        <h2 style={{ fontSize: 52, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}>Case: Floyd.no</h2>
        <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 24, padding: '2.5rem', marginBottom: 24 }}>
          <p style={{ ...bodyText, fontSize: 20 }}>Denne nettbutikken fikk <span style={{ color: '#38bdf8', fontWeight: 800, fontSize: 24 }}>2 millioner kr i bot</span> i 2025 fordi de brukte førpriser som ikke var ekte.</p>
        </div>
        <p style={{ color: '#64748b', fontSize: 16, fontStyle: 'italic' }}>Det ble dyrt å lure kundene!</p>
      </div>
    </Glass>
  )
}
...
function Slide7({ show }: { show: (t: string, d: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul 9 – Slide 7</SlideLabel>
          <h2 style={{ fontSize: 42, fontWeight: 800, marginBottom: 24, lineHeight: 1.1 }}>Direkte markedsføring og <Term word="Opt-in" onShow={show} /></h2>
          <p style={bodyText}>Bedrifter har ikke lov til å sende deg reklame på SMS eller e-post hvis du ikke har sagt "ja takk" først (opt-in).</p>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1557838923-2985c318be48?auto=format&fit=crop&w=800&q=80" alt="Direkte markedsføring" />
      </div>
    </Glass>
  )
}
...
function Slide8() {
  return (
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        <SlideLabel>Modul 9 – Slide 8 – Refleksjon</SlideLabel>
        ...
        <div style={{ background: 'rgba(56,189,248,0.08)', border: '2px dashed rgba(56,189,248,0.3)', borderRadius: 24, padding: '3rem' }}>
          <p style={{ fontSize: 26, color: '#e2e8f0', lineHeight: 1.6, fontWeight: 300, fontStyle: 'italic' }}>
            "Hva betyr det for en bedrift hvis kundene slutter å stole på reklamen deres?"
          </p>
        </div>
      </div>
    </Glass>
...
export default function RegelverkMarkedsforingPresentation() {
  ...
  function startLiveSession() {
    ...
    localStorage.setItem(`adventure-live-session-${pin}`, JSON.stringify({
      ...
      status: 'active',
      presentationName: 'Regelverk for markedsføring',
    }))
    setLivePin(pin)
