...
const TERMS: Record<string, string> = {
  'IHIP': 'De fire særtrekkene ved reiselivstjenester: Immaterielt, inseparabilitet (produksjon og konsum skjer samtidig), Perishability (forgjengelighet) og Variabilitet.',
  'Perishability': 'Forgjengelighet — et hotellrom som ikke selges i natt er tapt inntekt for alltid. Tjenester kan ikke lagres.',
  'Opplevelsesøkonomi': 'Pine og Gilmores teori om at bedrifter bør iscenesette opplevelser, ikke bare levere tjenester. Kombinasjon av underholdning, utdanning, estetikk og eskapisme.',
  'Yield management': 'Prisstrategi som maksimerer inntekten fra fast kapasitet ved å variere prisen etter etterspørsel, sesong og bestillingstidspunkt.',
  'RevPAR': 'Revenue Per Available Room — total rominntekt delt på antall tilgjengelige rom. Bransjens nøkkeltall for hoteller.',
  'Overtourism': 'Situasjon der turiststrømmen overstiger destinasjonens bæreevne sosialt, miljømessig og infrastrukturelt.',
  'Bundling': 'Å pakke flere reiselivskomponenter (fly, hotell, aktiviteter) til ett produkt til én pris for å skape bekvemmelighet.',
  'OTA': 'Online Travel Agency — digitale plattformer som Expedia og Booking.com der kunder sammenstiller egne reisepakker.',
  'Svanemerket': 'Nordens offisielle miljømerke for hoteller og opplevelsesleverandører — brukes som signal om miljøansvar og bærekraft.',
  'Dynamisk prising': 'Prissetting som justeres automatisk basert på etterspørsel, sesong og bestillingsvindu — kjernen i yield management.',
}

const QUIZ_SLIDES: QuizQuestion[] = [
  {
    question: 'Hva betyr Perishability i reiselivssammenheng?',
    options: [
      'At reiselivsprodukter er for dyre for mange kunder',
      'At usolgte kapasitetsenheter (rom, seter, turer) er tapt inntekt for alltid — de kan ikke lagres',
      'At reiselivsopplevelser slites raskere enn fysiske produkter',
      'At turister har kortere oppmerksomhetsspenn enn andre kunder',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  {
    question: 'Et hotellrom koster 800 kr i januar og 3 200 kr i juli. Hva er årsaken?',
    options: [
      'Hotellet har betydelig høyere driftskostnader om sommeren',
      'Det er en tilfeldighet basert på lokalt arrangement',
      'Yield management — algoritmen justerer pris etter etterspørsel og historiske beleggsmønstre',
      'Sommerprisene er lovregulert av Forbrukertilsynet',
    ],
    correct: 2,
    timeSeconds: 45,
  },
  {
    question: 'Pine og Gilmores "sweet spot" i opplevelsesøkonomien oppnås når et produkt kombinerer alle fire riker. Hvilke?',
    options: [
      'Natur, Kultur, Gastronomi og Sport',
      'Underholdning, Utdanning, Estetikk og Eskapisme',
      'Transport, Overnatting, Aktiviteter og Guiding',
      'Luksus, Budsjett, Eventyr og Familie',
    ],
    correct: 1,
    timeSeconds: 45,
  },
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: 'clamp(3rem, 10vw, 8rem)', fontWeight: 800, marginBottom: 32, letterSpacing: '-0.03em', lineHeight: 1.05 }}>
        Reiselivs-<br />
        <span style={{ color: '#38bdf8', fontStyle: 'italic' }}>produktet</span>
      </h1>
      <p style={{ fontSize: 22, color: '#94a3b8', marginBottom: 48, maxWidth: 600, margin: '0 auto 48px', fontWeight: 300, lineHeight: 1.6 }}>
        Opplevelsesøkonomi, servicepyramide og verdiskaping i reiseliv
      </p>
...
function Slide1({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Modul – Reiselivsproduktet</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            De fire særtrekkene: <Term word="IHIP" onShow={onShow} />
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#38bdf8' }}>I</strong> — Immaterielt: Kunden kjøper et løfte om en opplevelse.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#38bdf8' }}>H</strong> — Inseparabilitet: Produksjon og konsum skjer samtidig.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#38bdf8' }}>I</strong> — <Term word="Perishability" onShow={onShow} />: Usolgte kapasitetsenheter er tapt inntekt.</li>
            <li style={bodyText}><strong style={{ color: '#38bdf8' }}>P</strong> — Variabilitet: Standardisering gjennom opplæring er nøkkelen.</li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=800&q=80" alt="Reiselivsprodukt" />
      </div>
    </Glass>
  )
}
...
function Slide2({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80" alt="Opplevelsesøkonomi" />
        <div>
          <SlideLabel>Pine og Gilmore</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Opplevelsesøkonomi" onShow={onShow} />
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Underholdning:</strong> Passiv absorpsjon — kunden ser og lytter.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Utdanning:</strong> Aktiv kunnskapstilegnelse.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Estetikk:</strong> Passive, vakre omgivelser.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}>Eskapisme:</strong> Aktiv deltakelse i et annet univers — rafting, klatring.</li>
          </ul>
        </div>
      </div>
    </Glass>
...
function Slide3({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Produktstruktur</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Pakkereiser og <Term word="Bundling" onShow={onShow} />
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>5 standardkomponenter:</strong> Transport, overnatting, aktiviteter, guiding og måltider.</li>
            <li style={{ ...bodyText, marginBottom: 8 }}><strong style={{ color: '#f1f5f9' }}>Bundlingsmargin:</strong> Arrangøren bærer risikoen og koordinerer — kunden betaler for trygghet.</li>
            <li style={bodyText}><strong style={{ color: '#f1f5f9' }}><Term word="OTA" onShow={onShow} />:</strong> Expedia og Booking.com tilbyr dynamiske pakker i sanntid.</li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=800&q=80" alt="Pakkereiser" />
      </div>
    </Glass>
  )
}
...
function Slide4({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80" alt="Yield management" />
        <div>
          <SlideLabel>Prissetting</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Yield management" onShow={onShow} /> og <Term word="Dynamisk prising" onShow={onShow} />
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Bergen-hoteller er 4× dyrere i juli enn i januar. Dette er bevisst strategi, ikke tilfeldighet.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>
              <Term word="RevPAR" onShow={onShow} /> = Total rominntekt / Antall tilgjengelige rom
            </p>
          </div>
        </div>
      </div>
...
function Slide5({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Bærekraft</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            <Term word="Overtourism" onShow={onShow} /> og bærekraftig reiseliv
          </h2>
          <ul style={listStyle}>
            <li style={{ ...bodyText, marginBottom: 8 }}>
              <strong style={{ color: '#f1f5f9' }}>Paradokset:</strong> Turismen ødelegger de verdiene som tiltrekker turistene.
            </li>
            <li style={{ ...bodyText, marginBottom: 8 }}>
              <strong style={{ color: '#f1f5f9' }}>Geiranger:</strong> Begrenset cruiseskip med svovelutslipp for å beskytte fjorden.
            </li>
            <li style={bodyText}>
              <strong style={{ color: '#f1f5f9' }}><Term word="Svanemerket" onShow={onShow} />:</strong> Bærekraftssertifisering som gir konkurransefortrinn.
            </li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=800&q=80" alt="Bærekraftig reiseliv" />
      </div>
    </Glass>
  )
}
...
function Slide6({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80" alt="Flåmsbanen" />
        <div>
          <SlideLabel>Case: Flåmsbanen</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Fra lokal togtur til globalt produkt
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Flåmsbanen kombinerte tog, landskap, kulturhistorie og fotomuligheter til ett helhetlig produkt. Kunden kjøper ikke en togbillett — de kjøper en <Term word="Opplevelsesøkonomi" onShow={onShow} />-komposisjon.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>
              Rangert blant verdens beste togreiser av World Economic Forum.
            </p>
          </div>
        </div>
      </div>
...
function Slide7({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Case: Nærøyfjorden</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            UNESCO og betalingsvilje
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Nærøyfjordens UNESCO-status tredoblet prisene for fjordopplevelser over ti år. Statusen ga produktet en ny dimensjon av autentisitet og knapphet som økte betalingsviljen dramatisk.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>
              Eksklusivitet og anerkjennelse øker betalingsvilje — folk betaler for noe unikt.
            </p>
          </div>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80" alt="Nærøyfjorden" />
      </div>
    </Glass>
  )
}
...
function Slide8({ onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <SlideImg src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=800&q=80" alt="Overbooking" />
        <div>
          <SlideLabel>Kapasitetsstyring</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Overbooking — strategi, ikke feil
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Overbooking er en bevisst <Term word="Yield management" onShow={onShow} />-strategi basert på statistiske no-show-rater. Det er lovlig i Norge når alternativ innkvartering tilbys.
          </p>
          <div style={{ background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 16, padding: '1rem 1.5rem' }}>
            <p style={{ ...bodyText, color: '#38bdf8', fontWeight: 700 }}>
              Tidlig bestilling belønnes med lavere pris fordi bedriften sikrer inntekt tidlig og reduserer risiko.
            </p>
          </div>
        </div>
      </div>
...
function Slide9({ onShow: _onShow }: { onShow: (title: string, text: string) => void }) {
  return (
    <Glass>
      <div style={twoCol}>
        <div>
          <SlideLabel>Hurtigruten</SlideLabel>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: 800, marginBottom: 24, lineHeight: 1.2 }}>
            Kombinasjon av opplevelsesriker
          </h2>
          <p style={{ ...bodyText, marginBottom: 16 }}>
            Hurtigruten kombinerer underholdning, utdanning og eskapisme. Det er ikke bare transport — det er en fortelling om norsk natur, kultur og hverdagsliv.
          </p>
          <ul style={listStyle}>
            <li style={bodyText}>Rik kombinasjon av opplevelsesriker gir helhetlig opplevelse.</li>
            <li style={{ ...bodyText, marginTop: 8 }}>Kombinasjonen berettiger premium-prising i det internasjonale markedet.</li>
          </ul>
        </div>
        <SlideImg src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80" alt="Hurtigruten" />
      </div>
    </Glass>
  )
}
    ...
    <Glass>
      <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 4rem)', fontWeight: 800, marginBottom: 32, lineHeight: 1.2 }}>
          Et dårlig måltid på siste dag kan ødelegge en ellers perfekt reise. Men en uventet solnedgang over Nærøyfjorden kan forvandle en middelmådig tur til noe folk snakker om resten av livet. Hva sier dette om servicekvalitet?
        </h2>
        <p style={{ ...bodyText, fontSize: 20 }}>
          Reiselivsproduktet er bare så sterkt som det svakeste leddet — men en enkelt ekstraordinær opplevelse kan overskygge alt annet.
        </p>
      </div>
    </Glass>
  )
...
export default function ReiselivsproduktVg2Presentation() {
  ...
  function startLiveSession() {
    ...
    localStorage.setItem(`adventure-live-session-${pin}`, JSON.stringify({
      ...
      status: 'active',
      presentationName: 'Reiselivsproduktet',
    }))
    setLivePin(pin)
