...
export default function ProfesjonellKommunikasjonModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/kommunikasjon/profesjonell-kommunikasjon/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/profesjonell-kommunikasjon-vg2', description: 'Profesjonell kommunikasjon — en visuell gjennomgang av kommunikasjonskanaler' }}
    />
  );
}
