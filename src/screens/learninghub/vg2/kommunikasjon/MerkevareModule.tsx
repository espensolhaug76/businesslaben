...
export default function MerkevareModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/kommunikasjon/merkevare/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/merkevare-vg2', description: 'Merkevare og markedsstrategi — en visuell gjennomgang av merkevarebygging' }}
    />
  )
}
