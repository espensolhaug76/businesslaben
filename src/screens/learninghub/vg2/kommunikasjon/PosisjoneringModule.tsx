...
export default function PosisjoneringModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/kommunikasjon/posisjonering/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/posisjonering-vg2', description: 'Merkevarebygging — en visuell gjennomgang av STP og posisjonering' }}
    />
  )
}
