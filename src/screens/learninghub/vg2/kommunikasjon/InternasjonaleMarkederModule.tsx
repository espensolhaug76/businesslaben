...
export default function InternasjonaleMarkederModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/kommunikasjon/internasjonale-markeder/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/internasjonale-markeder-vg2', description: 'Internasjonale markeder — en visuell gjennomgang av eksport og global handel' }}
    />
  );
}
