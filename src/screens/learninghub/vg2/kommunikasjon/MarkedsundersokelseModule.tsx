...
export default function MarkedsundersokelseModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/kommunikasjon/markedsundersokelse/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/markedsundersokelse-vg2', description: 'Markedsundersøkelse — en visuell gjennomgang av metode og datainnsamling' }}
    />
  )
}
