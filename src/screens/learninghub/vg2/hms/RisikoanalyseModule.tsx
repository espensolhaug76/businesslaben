...
export default function RisikoanalyseModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/hms/risikoanalyse/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/risikoanalyse-vg2', description: 'Risikoanalyse — en visuell gjennomgang av ROS-analyse og trusselbilder' }}
    />
  )
}
