...
export default function SvinnforebyggingModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/okonomi/svinnforebygging/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/svinnforebygging', description: 'Svinnforebygging — typer, årsaker, konsekvenser og tiltak' }}
    />
  )
}
