...
export default function ForretningsplanModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/okonomi/forretningsplan/complete"
      phases={PHASES}
      ...
      presentationLink={{ route: '/learning/presentations/forretningsplan-vg2', description: 'Forretningsplanen — en visuell gjennomgang av BMC, pitch og kapitalbehov' }}
    />
  )
}
