...
export default function ReiseligsprodukModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/innovasjon/reiselivsprodukt/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/vertskapsrollen', description: 'Vertskapsrollen — en visuell gjennomgang av reiselivsprodukter og service' }}
    />
  )
}
