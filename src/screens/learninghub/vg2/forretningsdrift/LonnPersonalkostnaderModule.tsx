...
export default function LonnPersonalkostnaderModule() {
  return (
    <DrawerModule
      ...
      completeRoute="/learning/vg2/forretningsdrift/lonn-personalkostnader/complete"
      phases={phases}
      ...
      presentationLink={{ route: '/learning/presentations/administrative-funksjoner', description: 'Administrative funksjoner — en visuell gjennomgang av lønn og personalkostnader' }}
    />
  )
}
